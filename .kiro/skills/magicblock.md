<!--
source: https://github.com/magicblock-labs/magicblock-dev-skill/tree/5546320bff3e544825d9f678b5458057e1a653f3
commit: 5546320bff3e544825d9f678b5458057e1a653f3
fetched: 2026-05-11
-->
...
- Core delegation patterns: see [Delegation Patterns](#delegation-patterns-rust-programs) below
- TypeScript frontend setup: see [TypeScript Frontend Setup](#typescript-frontend-setup) below
- Cranks (scheduled tasks): see [Cranks](#cranks-scheduled-tasks) below
- VRF (randomness): see [VRF](#vrf-verifiable-random-function) below
- Reference links & versions: see [Resources & Reference](#resources--reference) below
